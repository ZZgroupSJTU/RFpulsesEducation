function [spinsOut, fid] = AcquireGrad3D(spinsIn,acqTime,numAcqPoints,Gx,Gy,Gz)
% Acquires the fid in the presence of a constant gradients Gx, Gy, Gz, given in kHz/mm.
% Relaxation is taken into account. Operates on a 3D spin structure (see: InitSpins3D).
%
% Input Parameters:
...
[spinsOut, fid] = ApplyPulse3D(spinsIn, pulse);