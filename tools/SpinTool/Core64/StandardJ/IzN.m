function M = IzN(idx, numNuclei, spin)
% Creates an Iz operator for a given spin.
%   M = IzN(idx, numNuclei) Create the Iz spin operator for the idx spin
%   in a spin system having numNuclei spin-half spins. The resulting
%   operator is a 2^numNuclei * 2^numNuclei matrix.
%
%   M = IzN(idx, numNuclei, spin) The optional vector input spin describes
